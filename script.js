(function() {
  ...
  const btnVChangeViewMode = document.getElementById('btn-change-view-mode');
  const imgViewMode = document.getElementById('img-view-mode');
  ...
  function AddViewModeControl() {
    btnVChangeViewMode.onclick = function() {
